#!/usr/bin/env node
/**
 * interest-memory — Claude Code UserPromptSubmit hook.
 *
 ...
 * memory context to stdout (Claude Code injects stdout text into context).
 * Never throws; failures degrade to a no-op.
 */
